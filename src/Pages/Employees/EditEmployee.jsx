...
function EditEmployee() {
  ...
  useEffect(() => {
    (async () => {
      ...
      debugger;
      setResult(response.data.data[0].profilePhoto);
      ...
      const resetObj = {
        ...
        confirmPassword: response.data.data[0].confirmPassword,
        phoneNumber: response.data.data[0].phoneNumber,
        address: response.data.data[0].address,
        joiningDate:
          response.data.data[0].recruiterBusinessDetails[0].joiningDate,
        company: response.data.data[0].recruiterBusinessDetails[0].company,
        position: response.data.data[0].recruiterBusinessDetails[0].position,
        airCraft: response.data.data[0].recruiterBusinessDetails[0].airCraft,
        description:
          response.data.data[0].recruiterBusinessDetails[0].description,
      };
      reset(resetObj);
      setloader(false);
    })();
